        ...
        >
          <ul className="nav__list">
            <li className="nav__item">
              <a onClick={onHomeClick} className="navbar-main-heading">Home</a>
            </li>
            <li className="nav__item">
              <a onClick={onFindAlabClick} className="navbar-main-heading">Find a Lab</a>
            ...
            <li className="nav__item">
              <a onClick={onPriceClick} className="navbar-main-heading">Price and Packages</a>
              <ul className="dropdown">
            ...
            <li className="nav__item">
              <a onClick={()=>{navigate("/diseases/overview")}}className="navbar-main-heading">STDs & Symptoms</a>
              <ul className="dropdown">
                <li className="dropdown-heading">STD Information & Symptoms</li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile(); navigate("/diseases/chlamydia")}}>Chlamydia</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/gonorrhea")}}>Gonorrhea</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/hep-a")}}>Hepatitis A</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/hep-b")}}>Hepatitis B</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/hep-c")}}>Hepatitis C</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/genital-herpes")}}>Genital Herpes</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/oral-herpes")}}>Oral Herpes</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/hiv")}}>HIV</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/syphilis")}}>Syphilis</a>
                </li>
                <li>
                  <a onClick={()=>{closeMenuOnMobile();navigate("/diseases/symptoms")}}>STD Symptoms</a>
                </li>
