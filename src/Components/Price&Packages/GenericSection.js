        ...
        <section><section className="TestPanelSection3">
            ...
            <div className="test-services">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#333333" fill-rule="evenodd" d="M14.25 2.5a.25.25 0 0 0-.25-.25H7A2.75 2.75 0 0 0 4.25 5v14A2.75 2.75 0 0 0 7 21.75h10A2.75 2.75 0 0 0 19.75 19V9.147a.25.25 0 0 0-.25-.25H15a.75.75 0 0 1-.75-.75zm.75 9.75a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5zm0 4a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5z" clip-rule="evenodd" /><path fill="3333333" d="M15.75 2.824c0-.184.193-.301.336-.186q.182.147.323.342l3.013 4.197c.068.096-.006.22-.124.22H16a.25.25 0 0 1-.25-.25z" /></svg>
                            <span className="mx-3 test-service-text">
                    ...
                    <div className="col-md-6">
                        <div className="d-flex align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="#333333" d="M22 3.94L12 .44L2 3.94V12c0 4.127 2.534 7.012 4.896 8.803a19.8 19.8 0 0 0 4.65 2.595q.17.064.342.122l.112.04l.114-.04a14 14 0 0 0 .65-.244a19.7 19.7 0 0 0 4.34-2.473C19.467 19.012 22 16.127 22 12zM11.001 15.415L6.76 11.172l1.414-1.415l2.828 2.829l5.657-5.657l1.415 1.414z" /></svg>
                            <span className="mx-3 test-service-text">
                ...
                <div className="test-services-flex">
                    ...
                    <div className="test-services-flex-text">
                        ...
                        <p>If one or more of your test results are positive, you can schedule a phone consultation with one of our doctors. During this consultation, one of our doctors will explain what your test results mean, answer any questions you might have, and can prescribe treatment at his or her discretion.</p>
            ...
            <section className="TestPanelSection4">
                <div className="Test-Panel-Transaction-Card">
                    <div className="Test-Panel-Transaction-Card-header">10 Test Panel</div>
                    <div className="Test-Panel-Transaction-Card-Text ">
                        <strong>No Long Delays - </strong>
                        Testing usually takes a few minutes and your results are available within 1-2 days.
                    </div>
                    <div className="Test-Panel-Transaction-Card-Text ">
